                ...
                <form onSubmit={submitForm} className="space-y-6 mb-16">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      placeholder="Tell us about your project requirements, website goals, or automation needs..."
                    ></textarea>
                  </div>
                  ...
                  <p className="text-xs text-white/40 text-center mt-2">
                    By submitting this form, you agree to our <Link to="/privacy-policy" className="text-primary hover:underline">Privacy Policy</Link> and <Link to="/terms-and-conditions" className="text-primary hover:underline">Terms & Conditions</Link>.
                  </p>
                </form>
              )}
            ...
            <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={3} className="h-full">
              <div className="w-full h-full glass-card-premium rounded-3xl border border-white/10 flex flex-col items-center p-4 lg:p-6 text-center relative overflow-hidden">
                ...
                <p className="text-white/60 mb-4 text-sm relative z-10 max-w-md">
                  Schedule a direct 10-minute call with our Lead AI Strategist using our live calendar below.
                </p>
                
                {/* Live Calendly Widget (Light Mode) */}
                <div className="w-full h-[880px] rounded-2xl overflow-hidden relative z-10 border border-white/20 shadow-2xl bg-white">
                  <iframe
