      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #09090B; color: #ffffff; padding: 30px; border-radius: 16px; border: 1px solid #1e293b;">
          ...
          <p style="color: #e2e8f0; line-height: 1.6;">
            We've received your inquiry for <strong>${company || 'your business'}</strong>.
          </p>
          <p style="color: #94a3b8; line-height: 1.6;">
            Our Lead Strategist is reviewing your requirements and will reach out to you within <strong>24 business hours</strong>.
          </p>
